...
import { emitError, jsonFlatten, JSONDataType, cloneDeep } from '../../utils';
import './styles.less';
...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const propsErrorMessage = computed(() => {
            const error =
                props.selectableType && !props.selectOnClickNode && !props.showSelectController;
            return error
                ...
                <div
                    ...
                    style={
                        props.showLineNumber
                            ? {
                                  paddingLeft: `${
                                      Number(originFlatData.value.length.toString().length) * 12
                                  }px`,
                                  ...props.style
                              }
                            : props.style

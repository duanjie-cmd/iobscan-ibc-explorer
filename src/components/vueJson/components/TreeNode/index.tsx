...
import { getDataType, JSONFlattenReturnType, stringToAutoType } from '../../utils';
import './styles.less';
            ...
            return (
                ...
                >
                    ...
                    <div class="vjs-indent">
                        ...
                        {props.showIcon && (
                            <Carets nodeType={node.type} onClick={handleIconClick} />
                        )}
                    </div>
                    ...
                    <span>
                        {node.type !== 'content' && node.content ? (
                            ...
                            <span
                                ...
                                onClick={
                                    props.editable &&
                                    (!props.editableTrigger || props.editableTrigger === 'click')
                                        ? handleValueEdit
                                        : undefined
                                }
                                onDblclick={
